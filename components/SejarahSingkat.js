...
export default function SejarahSingkat() {
  return (
    <div className='container mx-auto mt-2 bg-slate-200'>
        ...
        <div className='mx-5 text-sm md:mx-10 lg:mx-28 xl:mx-56 py-7 text-justify'>
            ...
            <p>
            Pengasuh menduduki posisi tertinggi dalam hirarki kepemimpinan sebuah pesantren , termasuk di Yayasan Daar El Sakinah Dewan Pengasuh harian adalah para pimpinan pesantren yang secara fisikal berada di lingkungan Yayasan Daar El Sakinah dan terlibat langsung dalam urusan keseharian yayasan. Sedang Dewan Konsultatif secara fisik tidak selalu berada lingkungan Yayasan karena tidak terlibat langsung dalam aktivitas keseharian dan pengambilan keputusan pesantren. Namun demikian, Dewan Konsultatif tetap berkontribusi dalam pengambilan keputusan pada situasi tertentu
            </p>
        </div>
    </div>
  )
